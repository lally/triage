...
Fay.FFI.Undefined = new $(function(){
...
Prelude.maybe = function($p1){
  return function($p2){
    return function($p3){
      return new $(function(){
        if (_($p3) instanceof Prelude._Nothing) {
          var m = $p1;
          return m;
        }
        if (_($p3) instanceof Prelude._Just) {
          var x = _($p3).slot1;
          var f = $p2;
          return _(f)(x);
        }
...
Prelude.when = function($p1){
  return function($p2){
    return new $(function(){
      var m = $p2;
      var p = $p1;
      return _(p) ? m : _(Fay$$$_return)(Fay$$unit);
    });
  };
};
Prelude.unless = function($p1){
  return function($p2){
    return new $(function(){
      var m = $p2;
      var p = $p1;
      return _(p) ? _(Fay$$$_return)(Fay$$unit) : m;
    });
  };
};
Prelude.forM = function($p1){
  return function($p2){
    return new $(function(){
      var fn = $p2;
      var lst = $p1;
      return _(_(Prelude["$"])(Prelude.sequence))(_(_(Prelude.map)(fn))(lst));
    });
  };
};
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        var x = $tmp1.car;
        var xs = $tmp1.cdr;
        return _(_(Fay$$then)(_(m)(x)))(_(_(Prelude.forM_)(xs))(m));
      }
      if (_($p1) === null) {
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var m = $p1;
        return _(_(Fay$$then)(_(m)(x)))(_(_(Prelude.mapM_)(m))(xs));
      }
      if (_($p2) === null) {
        return _(Fay$$$_return)(Fay$$unit);
      }
...
Prelude.$_void = function($p1){
  return new $(function(){
    var f = $p1;
    return _(_(Fay$$then)(f))(_(Fay$$$_return)(Fay$$unit));
  });
};
Prelude[">=>"] = function($p1){
  return function($p2){
...
Prelude.sequence = function($p1){
  return new $(function(){
    ...
    return (function(){
      ...
      return _(_(_(Prelude.foldr)(k))(_(Fay$$$_return)(null)))(ms);
    })();
  });
};
Prelude.sequence_ = function($p1){
  return new $(function(){
    ...
    if ($tmp1 instanceof Fay$$Cons) {
      var m = $tmp1.car;
      var ms = $tmp1.cdr;
      return _(_(Fay$$then)(m))(_(Prelude.sequence_)(ms));
    }
...
Prelude.compare = function($p1){
  return function($p2){
    return new $(function(){
      var y = $p2;
      var x = $p1;
      return _(_(_(Fay$$gt)(x))(y)) ? Prelude.GT : _(_(_(Fay$$lt)(x))(y)) ? Prelude.LT : Prelude.EQ;
    });
  };
};
Prelude.succ = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(Fay$$add)(x))(1);
  });
};
Prelude.pred = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(Fay$$sub)(x))(1);
  });
};
Prelude.enumFrom = function($p1){
  return new $(function(){
    var i = $p1;
    return _(_(Fay$$cons)(i))(_(Prelude.enumFrom)(_(_(Fay$$add)(i))(1)));
  });
};
Prelude.enumFromTo = function($p1){
  return function($p2){
    return new $(function(){
      var n = $p2;
      var i = $p1;
      return _(_(_(Fay$$gt)(i))(n)) ? null : _(_(Fay$$cons)(i))(_(_(Prelude.enumFromTo)(_(_(Fay$$add)(i))(1)))(n));
    });
  };
};
Prelude.enumFromBy = function($p1){
  return function($p2){
    return new $(function(){
      var by = $p2;
      var fr = $p1;
      return _(_(Fay$$cons)(fr))(_(_(Prelude.enumFromBy)(_(_(Fay$$add)(fr))(by)))(by));
    });
  };
};
Prelude.enumFromThen = function($p1){
  return function($p2){
    return new $(function(){
      var th = $p2;
      var fr = $p1;
      return _(_(Prelude.enumFromBy)(fr))(_(_(Fay$$sub)(th))(fr));
    });
  };
};
      ...
      return new $(function(){
        ...
        return (function(){
          var neg = function($p1){
            return new $(function(){
              var x = $p1;
              return _(_(_(Fay$$lt)(x))(to)) ? null : _(_(Fay$$cons)(x))(_(neg)(_(_(Fay$$add)(x))(by)));
            });
          };
          var pos = function($p1){
            return new $(function(){
              var x = $p1;
              return _(_(_(Fay$$gt)(x))(to)) ? null : _(_(Fay$$cons)(x))(_(pos)(_(_(Fay$$add)(x))(by)));
            });
          };
          return _(_(_(Fay$$lt)(by))(0)) ? _(neg)(fr) : _(pos)(fr);
        })();
      });
    };
  };
  ...
  return function($p2){
    return function($p3){
      return new $(function(){
        ...
        var th = $p2;
        var fr = $p1;
        return _(_(_(Prelude.enumFromByTo)(fr))(_(_(Fay$$sub)(th))(fr)))(to);
      });
    };
  };
};
...
Prelude.$_undefined = new $(function(){
  return _(Prelude.error)(Fay$$list("Prelude.undefined"));
});
Prelude.either = function($p1){
  return function($p2){
    return function($p3){
      return new $(function(){
        if (_($p3) instanceof Prelude._Left) {
          var a = _($p3).slot1;
          var f = $p1;
          return _(f)(a);
        }
        if (_($p3) instanceof Prelude._Right) {
          var b = _($p3).slot1;
          var g = $p2;
          return _(g)(b);
        }
  ...
  return function($p2){
    return function($p3){
      return new $(function(){
        ...
        var f = $p2;
        var p = $p1;
        return _(_(p)(x)) ? x : _(_(_(Prelude.until)(p))(f))(_(f)(x));
      });
    };
  };
};
...
Prelude.div = function($p1){
  return function($p2){
    return new $(function(){
      var y = $p2;
      var x = $p1;
      if (_(_(_(Fay$$and)(_(_(Fay$$gt)(x))(0)))(_(_(Fay$$lt)(y))(0)))) {
        return _(_(Fay$$sub)(_(_(Prelude.quot)(_(_(Fay$$sub)(x))(1)))(y)))(1);
      } else {
        if (_(_(_(Fay$$and)(_(_(Fay$$lt)(x))(0)))(_(_(Fay$$gt)(y))(0)))) {
          return _(_(Fay$$sub)(_(_(Prelude.quot)(_(_(Fay$$add)(x))(1)))(y)))(1);
        }
      }
      var y = $p2;
      var x = $p1;
      return _(_(Prelude.quot)(x))(y);
    });
  };
};
Prelude.mod = function($p1){
  return function($p2){
    return new $(function(){
      ...
      var x = $p1;
      if (_(_(_(Fay$$and)(_(_(Fay$$gt)(x))(0)))(_(_(Fay$$lt)(y))(0)))) {
        return _(_(Fay$$add)(_(_(Fay$$add)(_(_(Prelude.rem)(_(_(Fay$$sub)(x))(1)))(y)))(y)))(1);
      } else {
        if (_(_(_(Fay$$and)(_(_(Fay$$lt)(x))(0)))(_(_(Fay$$gt)(y))(0)))) {
          return _(_(Fay$$sub)(_(_(Fay$$add)(_(_(Prelude.rem)(_(_(Fay$$add)(x))(1)))(y)))(y)))(1);
        }
      }
      var y = $p2;
      var x = $p1;
      return _(_(Prelude.rem)(x))(y);
    });
  };
};
      ...
      if (_(_(_(Fay$$and)(_(_(Fay$$gt)(x))(0)))(_(_(Fay$$lt)(y))(0)))) {
        return (function($tmp1){
          if (Fay$$listLen(_($tmp1),2)) {
            ...
            return Fay$$list([_(_(Fay$$sub)(q))(1),_(_(Fay$$add)(_(_(Fay$$add)(r))(y)))(1)]);
          }
          return (function(){ throw (["unhandled case",$tmp1]); })();
        })(_(_(Prelude.quotRem)(_(_(Fay$$sub)(x))(1)))(y));
      } else {
        if (_(_(_(Fay$$and)(_(_(Fay$$lt)(x))(0)))(_(_(Fay$$gt)(y))(1)))) {
          return (function($tmp1){
            if (Fay$$listLen(_($tmp1),2)) {
              var q = Fay$$index(0,_($tmp1));
              var r = Fay$$index(1,_($tmp1));
              return Fay$$list([_(_(Fay$$sub)(q))(1),_(_(Fay$$sub)(_(_(Fay$$add)(r))(y)))(1)]);
            }
            return (function(){ throw (["unhandled case",$tmp1]); })();
          })(_(_(Prelude.quotRem)(_(_(Fay$$add)(x))(1)))(y));
        }
      }
      var y = $p2;
      var x = $p1;
      return _(_(Prelude.quotRem)(x))(y);
    });
  };
};
...
Prelude.abs = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(_(Fay$$lt)(x))(0)) ? _(Prelude.negate)(x) : x;
  });
};
Prelude.signum = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(_(Fay$$gt)(x))(0)) ? 1 : _(_(_(Fay$$eq)(x))(0)) ? 0 : (-(1));
  });
};
Prelude.pi = new $(function(){
...
Prelude["^"] = function($p1){
  return function($p2){
    return new $(function(){
      ...
      var a = $p1;
      if (_(_(_(Fay$$lt)(b))(0))) {
        return _(Prelude.error)(Fay$$list("(^): negative exponent"));
      } else {
        if (_(_(_(Fay$$eq)(b))(0))) {
          return 1;
        } else {
          if (_(_(Prelude.even)(b))) {
            return (function(){
              return new $(function(){
                var x = new $(function(){
                  return _(_(Prelude["^"])(a))(_(_(Prelude.quot)(b))(2));
                });
                return _(_(Fay$$mult)(x))(x);
              });
            })();
          }
        }
      ...
      var b = $p2;
      var a = $p1;
      return _(_(Fay$$mult)(a))(_(_(Prelude["^"])(a))(_(_(Fay$$sub)(b))(1)));
    });
  };
};
Prelude.logBase = function($p1){
  return function($p2){
    return new $(function(){
      var x = $p2;
      var b = $p1;
      return _(_(Fay$$divi)(_(Prelude.log)(x)))(_(Prelude.log)(b));
    });
  };
};
...
Prelude.sinh = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(Fay$$divi)(_(_(Fay$$sub)(_(Prelude.exp)(x)))(_(Prelude.exp)((-(_(x)))))))(2);
  });
};
Prelude.tanh = function($p1){
  return new $(function(){
    ...
    return (function(){
      return new $(function(){
        var a = new $(function(){
          return _(Prelude.exp)(x);
        });
        var b = new $(function(){
          return _(Prelude.exp)((-(_(x))));
        });
        return _(_(Fay$$divi)(_(_(Fay$$sub)(a))(b)))(_(_(Fay$$add)(a))(b));
      });
    })();
  });
};
Prelude.cosh = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(Fay$$divi)(_(_(Fay$$add)(_(Prelude.exp)(x)))(_(Prelude.exp)((-(_(x)))))))(2);
  });
};
Prelude.asinh = function($p1){
  return new $(function(){
    var x = $p1;
    return _(Prelude.log)(_(_(Fay$$add)(x))(_(Prelude.sqrt)(_(_(Fay$$add)(_(_(Prelude["**"])(x))(2)))(1))));
  });
};
Prelude.atanh = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(Fay$$divi)(_(Prelude.log)(_(_(Fay$$divi)(_(_(Fay$$add)(1))(x)))(_(_(Fay$$sub)(1))(x)))))(2);
  });
};
Prelude.acosh = function($p1){
  return new $(function(){
    var x = $p1;
    return _(Prelude.log)(_(_(Fay$$add)(x))(_(Prelude.sqrt)(_(_(Fay$$sub)(_(_(Prelude["**"])(x))(2)))(1))));
  });
};
Prelude.properFraction = function($p1){
  return new $(function(){
    ...
    return (function(){
      return new $(function(){
        var a = new $(function(){
          return _(Prelude.truncate)(x);
        });
        return Fay$$list([a,_(_(Fay$$sub)(x))(_(Prelude.fromIntegral)(a))]);
      });
    })();
  });
};
Prelude.truncate = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(_(Fay$$lt)(x))(0)) ? _(Prelude.ceiling)(x) : _(Prelude.floor)(x);
  });
};
...
Prelude.subtract = new $(function(){
  return _(Prelude.flip)(Fay$$sub);
});
Prelude.even = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(Fay$$eq)(_(_(Prelude.rem)(x))(2)))(0);
  });
};
Prelude.odd = function($p1){
  return new $(function(){
    var x = $p1;
    return _(Prelude.not)(_(Prelude.even)(x));
  });
};
        ...
        var go = function($p1){
          return function($p2){
            return new $(function(){
              ...
              var y = $p2;
              var x = $p1;
              return _(_(go)(y))(_(_(Prelude.rem)(x))(y));
            });
          };
        };
        return _(_(go)(_(Prelude.abs)(a)))(_(Prelude.abs)(b));
      })();
    });
  };
};
Prelude.quot = function($p1){
  return function($p2){
    return new $(function(){
      var y = $p2;
      var x = $p1;
      return _(_(_(Fay$$eq)(y))(0)) ? _(Prelude.error)(Fay$$list("Division by zero")) : _(_(Prelude["quot'"])(x))(y);
    });
  };
};
Prelude["quot'"] = function($p1){
...
Prelude.quotRem = function($p1){
  return function($p2){
    return new $(function(){
      var y = $p2;
      var x = $p1;
      return Fay$$list([_(_(Prelude.quot)(x))(y),_(_(Prelude.rem)(x))(y)]);
    });
  };
};
Prelude.rem = function($p1){
  return function($p2){
    return new $(function(){
      var y = $p2;
      var x = $p1;
      return _(_(_(Fay$$eq)(y))(0)) ? _(Prelude.error)(Fay$$list("Division by zero")) : _(_(Prelude["rem'"])(x))(y);
    });
  };
};
Prelude["rem'"] = function($p1){
...
Prelude.lcm = function($p1){
  return function($p2){
    return new $(function(){
      ...
      var b = $p2;
      var a = $p1;
      return _(Prelude.abs)(_(_(Fay$$mult)(_(_(Prelude.quot)(a))(_(_(Prelude.gcd)(a))(b))))(b));
    });
  };
};
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var p = $p1;
        return _(_(p)(x)) ? _(Prelude.Just)(x) : _(_(Prelude.find)(p))(xs);
      }
      if (_($p2) === null) {
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var p = $p1;
        return _(_(p)(x)) ? _(_(Fay$$cons)(x))(_(_(Prelude.filter)(p))(xs)) : _(_(Prelude.filter)(p))(xs);
      }
      if (_($p2) === null) {
        return null;
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var f = $p1;
        return _(_(Fay$$cons)(_(f)(x)))(_(_(Prelude.map)(f))(xs));
      }
...
Prelude.nub = function($p1){
  return new $(function(){
    var ls = $p1;
    return _(_(Prelude["nub'"])(ls))(null);
  });
};
Prelude["nub'"] = function($p1){
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        var x = $tmp1.car;
        var xs = $tmp1.cdr;
        return _(_(_(Prelude.elem)(x))(ls)) ? _(_(Prelude["nub'"])(xs))(ls) : _(_(Fay$$cons)(x))(_(_(Prelude["nub'"])(xs))(_(_(Fay$$cons)(x))(ls)));
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var ys = $tmp1.cdr;
        var x = $p1;
        return _(_(Fay$$or)(_(_(Fay$$eq)(x))(y)))(_(_(Prelude.elem)(x))(ys));
      }
      if (_($p2) === null) {
        return false;
      }
...
Prelude.notElem = function($p1){
  return function($p2){
    return new $(function(){
      var ys = $p2;
      var x = $p1;
      return _(Prelude.not)(_(_(Prelude.elem)(x))(ys));
    });
  };
};
Prelude.sort = new $(function(){
  return _(Prelude.sortBy)(Prelude.compare);
});
Prelude.sortBy = function($p1){
  return new $(function(){
    var cmp = $p1;
    return _(_(Prelude.foldr)(_(Prelude.insertBy)(cmp)))(null);
  });
};
        ...
        return (function($tmp1){
          ...
          if ($tmp2 instanceof Fay$$Cons) {
            ...
            return (function($tmp2){
              if (_($tmp2) instanceof Prelude._GT) {
                return _(_(Fay$$cons)(y))(_(_(_(Prelude.insertBy)(cmp))(x))(ys$39$));
              }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        var x = $tmp1.car;
        var xs = $tmp1.cdr;
        return _(_(Fay$$cons)(x))(_(_(Prelude.conc)(xs))(ys));
      }
      var ys = $p2;
      if (_($p1) === null) {
        return ys;
...
Prelude.concat = new $(function(){
  return _(_(Prelude.foldr)(Prelude.conc))(null);
});
Prelude.concatMap = function($p1){
  return new $(function(){
    var f = $p1;
    return _(_(Prelude.foldr)(_(_(Prelude["."])(Prelude["++"]))(f)))(null);
  });
};
    ...
    return function($p3){
      return new $(function(){
        ...
        if ($tmp1 instanceof Fay$$Cons) {
          ...
          var z = $p2;
          var f = $p1;
          return _(_(f)(x))(_(_(_(Prelude.foldr)(f))(z))(xs));
        }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var f = $p1;
        return _(_(f)(x))(_(_(Prelude.foldr1)(f))(xs));
      }
      if (_($p2) === null) {
        return _(Prelude.error)(Fay$$list("foldr1: empty list"));
      }
    ...
    return function($p3){
      return new $(function(){
        ...
        if ($tmp1 instanceof Fay$$Cons) {
          ...
          var z = $p2;
          var f = $p1;
          return _(_(_(Prelude.foldl)(f))(_(_(f)(z))(x)))(xs);
        }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var f = $p1;
        return _(_(_(Prelude.foldl)(f))(x))(xs);
      }
      if (_($p2) === null) {
        return _(Prelude.error)(Fay$$list("foldl1: empty list"));
      }
      ...
      return (function(){
        var go = function($p1){
          return function($p2){
            return new $(function(){
              if (_($p1) === null) {
                return _(Prelude.error)(Fay$$list("(!!): index too large"));
              }
              if (_($p2) === 0) {
                var $tmp1 = _($p1);
                if ($tmp1 instanceof Fay$$Cons) {
              ...
              if ($tmp1 instanceof Fay$$Cons) {
                var t = $tmp1.cdr;
                return _(_(go)(t))(_(_(Fay$$sub)(n))(1));
              }
              throw ["unhandled case in go",[$p1,$p2]];
            });
          };
        };
        return _(_(_(Fay$$lt)(b))(0)) ? _(Prelude.error)(Fay$$list("(!!): negative index")) : _(_(go)(a))(b);
      })();
    });
  };
};
Prelude.head = function($p1){
  return new $(function(){
    if (_($p1) === null) {
      return _(Prelude.error)(Fay$$list("head: empty list"));
    }
    var $tmp1 = _($p1);
    if ($tmp1 instanceof Fay$$Cons) {
      var h = $tmp1.car;
...
Prelude.tail = function($p1){
  return new $(function(){
    if (_($p1) === null) {
      return _(Prelude.error)(Fay$$list("tail: empty list"));
    }
    var $tmp1 = _($p1);
    if ($tmp1 instanceof Fay$$Cons) {
      var t = $tmp1.cdr;
...
Prelude.init = function($p1){
  return new $(function(){
    if (_($p1) === null) {
      return _(Prelude.error)(Fay$$list("init: empty list"));
    }
    ...
    if ($tmp1 instanceof Fay$$Cons) {
      var h = $tmp1.car;
      var t = $tmp1.cdr;
      return _(_(Fay$$cons)(h))(_(Prelude.init)(t));
    }
...
Prelude.last = function($p1){
  return new $(function(){
    if (_($p1) === null) {
      return _(Prelude.error)(Fay$$list("last: empty list"));
    }
    if (Fay$$listLen(_($p1),1)) {
      var a = Fay$$index(0,_($p1));
      return a;
...
Prelude.iterate = function($p1){
  return function($p2){
    return new $(function(){
      var x = $p2;
      var f = $p1;
      return _(_(Fay$$cons)(x))(_(_(Prelude.iterate)(f))(_(f)(x)));
    });
  };
};
Prelude.repeat = function($p1){
  return new $(function(){
    var x = $p1;
    return _(_(Fay$$cons)(x))(_(Prelude.repeat)(x));
  });
};
Prelude.replicate = function($p1){
  return function($p2){
    return new $(function(){
      ...
      var x = $p2;
      var n = $p1;
      return _(_(_(Fay$$lt)(n))(0)) ? null : _(_(Fay$$cons)(x))(_(_(Prelude.replicate)(_(_(Fay$$sub)(n))(1)))(x));
    });
  };
};
Prelude.cycle = function($p1){
  return new $(function(){
    if (_($p1) === null) {
      return _(Prelude.error)(Fay$$list("cycle: empty list"));
    }
    var xs = $p1;
    return (function(){
      var xs$39$ = new $(function(){
        return _(_(Prelude["++"])(xs))(xs$39$);
      });
      return xs$39$;
    })();
  });
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var n = $p1;
        return _(_(_(Fay$$lt)(n))(0)) ? null : _(_(Fay$$cons)(x))(_(_(Prelude.take)(_(_(Fay$$sub)(n))(1)))(xs));
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var n = $p1;
        return _(_(_(Fay$$lt)(n))(0)) ? xss : _(_(Prelude.drop)(_(_(Fay$$sub)(n))(1)))(xs);
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var n = $p1;
        return _(_(_(Fay$$lt)(n))(0)) ? Fay$$list([null,_(_(Fay$$cons)(x))(xs)]) : (function($tmp1){
          if (Fay$$listLen(_($tmp1),2)) {
          ...
          return (function(){ throw (["unhandled case",$tmp1]); })();
        })(_(_(Prelude.splitAt)(_(_(Fay$$sub)(n))(1)))(xs));
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var p = $p1;
        return _(_(p)(x)) ? _(_(Fay$$cons)(x))(_(_(Prelude.takeWhile)(p))(xs)) : null;
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var p = $p1;
        return _(_(p)(x)) ? _(_(Prelude.dropWhile)(p))(xs) : _(_(Fay$$cons)(x))(xs);
      }
    ...
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        return _(_(p)(x)) ? (function($tmp1){
          ...
          return (function(){ throw (["unhandled case",$tmp1]); })();
        })(_(_(Prelude.span)(p))(xs)) : Fay$$list([null,_(_(Fay$$cons)(x))(xs)]);
      }
...
Prelude.$_break = function($p1){
  return new $(function(){
    var p = $p1;
    return _(Prelude.span)(_(_(Prelude["."])(Prelude.not))(p));
  });
};
      ...
      return new $(function(){
        ...
        if ($tmp1 instanceof Fay$$Cons) {
          ...
          if ($tmp1 instanceof Fay$$Cons) {
            ...
            var as = $tmp1.cdr;
            var f = $p1;
            return _(_(Fay$$cons)(_(_(f)(a))(b)))(_(_(_(Prelude.zipWith)(f))(as))(bs));
          }
        }
        return null;
      });
          ...
          if ($tmp1 instanceof Fay$$Cons) {
            ...
            if ($tmp1 instanceof Fay$$Cons) {
              ...
              if ($tmp1 instanceof Fay$$Cons) {
                ...
                var as = $tmp1.cdr;
                var f = $p1;
                return _(_(Fay$$cons)(_(_(_(f)(a))(b))(c)))(_(_(_(_(Prelude.zipWith3)(f))(as))(bs))(cs));
              }
            }
          }
          return null;
    ...
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        if ($tmp1 instanceof Fay$$Cons) {
          var a = $tmp1.car;
          var as = $tmp1.cdr;
          return _(_(Fay$$cons)(Fay$$list([a,b])))(_(_(Prelude.zip)(as))(bs));
        }
      }
      return null;
    });
        ...
        if ($tmp1 instanceof Fay$$Cons) {
          ...
          if ($tmp1 instanceof Fay$$Cons) {
            ...
            if ($tmp1 instanceof Fay$$Cons) {
              var a = $tmp1.car;
              var as = $tmp1.cdr;
              return _(_(Fay$$cons)(Fay$$list([a,b,c])))(_(_(_(Prelude.zip3)(as))(bs))(cs));
            }
          }
        }
        return null;
  ...
  return new $(function(){
    ...
    return (function(){
      var isLineBreak = function($p1){
        return new $(function(){
          var c = $p1;
          return _(_(Fay$$or)(_(_(Fay$$eq)(c))("\r")))(_(_(Fay$$eq)(c))("\n"));
        });
      };
      return (function($tmp1){
        if (Fay$$listLen(_($tmp1),2)) {
        ...
        if (Fay$$listLen(_($tmp1),2)) {
          ...
          if ($tmp2 instanceof Fay$$Cons) {
            var cs = $tmp2.cdr;
            return _(_(Fay$$cons)(a))(_(Prelude.lines)(cs));
          }
        }
        return (function(){ throw (["unhandled case",$tmp1]); })();
      })(_(_(Prelude.$_break)(isLineBreak))(s));
    })();
  });
};
Prelude.unlines = function($p1){
  return new $(function(){
    ...
    if ($tmp1 instanceof Fay$$Cons) {
      var l = $tmp1.car;
      var ls = $tmp1.cdr;
      return _(_(Prelude["++"])(l))(_(_(Fay$$cons)("\n"))(_(Prelude.unlines)(ls)));
    }
        ...
        return new $(function(){
          ...
          return (function($tmp1){
            if (Fay$$listLen(_($tmp1),2)) {
              var a = Fay$$index(0,_($tmp1));
              var b = Fay$$index(1,_($tmp1));
              return _(_(Fay$$cons)(a))(_(Prelude.words)(b));
            }
            return (function(){ throw (["unhandled case",$tmp1]); })();
          })(_(_(Prelude.$_break)(isSpace))(s));
        });
      };
      var isSpace = function($p1){
        return new $(function(){
          var c = $p1;
          return _(_(Prelude.elem)(c))(Fay$$list(" \t\r\n\u000c\u000b"));
        });
      };
      return _(words$39$)(_(_(Prelude.dropWhile)(isSpace))(str));
    })();
  });
};
Prelude.unwords = new $(function(){
  return _(Prelude.intercalate)(Fay$$list(" "));
});
Prelude.and = function($p1){
  return new $(function(){
    ...
    if ($tmp1 instanceof Fay$$Cons) {
      var x = $tmp1.car;
      var xs = $tmp1.cdr;
      return _(_(Fay$$and)(x))(_(Prelude.and)(xs));
    }
...
Prelude.or = function($p1){
  return new $(function(){
    ...
    if ($tmp1 instanceof Fay$$Cons) {
      var x = $tmp1.car;
      var xs = $tmp1.cdr;
      return _(_(Fay$$or)(x))(_(Prelude.or)(xs));
    }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var p = $p1;
        return _(_(Fay$$or)(_(p)(x)))(_(_(Prelude.any)(p))(xs));
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var p = $p1;
        return _(_(Fay$$and)(_(p)(x)))(_(_(Prelude.all)(p))(xs));
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var sep = $p1;
        return _(_(Fay$$cons)(x))(_(_(Prelude.prependToAll)(sep))(xs));
      }
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var sep = $p1;
        return _(_(Fay$$cons)(sep))(_(_(Fay$$cons)(x))(_(_(Prelude.prependToAll)(sep))(xs)));
      }
...
Prelude.intercalate = function($p1){
  return function($p2){
    return new $(function(){
      var xss = $p2;
      var xs = $p1;
      return _(Prelude.concat)(_(_(Prelude.intersperse)(xs))(xss));
    });
  };
};
Prelude.maximum = function($p1){
  return new $(function(){
    if (_($p1) === null) {
      return _(Prelude.error)(Fay$$list("maximum: empty list"));
    }
    var xs = $p1;
    return _(_(Prelude.foldl1)(Prelude.max))(xs);
  });
};
Prelude.minimum = function($p1){
  return new $(function(){
    if (_($p1) === null) {
      return _(Prelude.error)(Fay$$list("minimum: empty list"));
    }
    var xs = $p1;
    return _(_(Prelude.foldl1)(Prelude.min))(xs);
  });
};
Prelude.product = function($p1){
  return new $(function(){
    var xs = $p1;
    return _(_(_(Prelude.foldl)(Fay$$mult))(1))(xs);
  });
};
Prelude.sum = function($p1){
  return new $(function(){
    var xs = $p1;
    return _(_(_(Prelude.foldl)(Fay$$add))(0))(xs);
  });
};
      ...
      return new $(function(){
        ...
        return _(_(Fay$$cons)(z))((function($tmp1){
          ...
          if ($tmp2 instanceof Fay$$Cons) {
            var x = $tmp2.car;
            var xs = $tmp2.cdr;
            return _(_(_(Prelude.scanl)(f))(_(_(f)(z))(x)))(xs);
          }
          return (function(){ throw (["unhandled case",$tmp1]); })();
        })(l));
      });
  ...
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        ...
        var xs = $tmp1.cdr;
        var f = $p1;
        return _(_(_(Prelude.scanl)(f))(x))(xs);
      }
    ...
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        if (Fay$$listLen(_($tmp1.car),2)) {
          ...
          var xys = $tmp1.cdr;
          var key = $p1;
          return _(_(_(Fay$$eq)(key))(x)) ? _(Prelude.Just)(y) : _(_(Prelude.lookup)(key))(xys);
        }
      }
...
Prelude.length = function($p1){
  return new $(function(){
    var xs = $p1;
    return _(_(Prelude["length'"])(0))(xs);
  });
};
Prelude["length'"] = function($p1){
  return function($p2){
    return new $(function(){
      ...
      if ($tmp1 instanceof Fay$$Cons) {
        var xs = $tmp1.cdr;
        var acc = $p1;
        return _(_(Prelude["length'"])(_(_(Fay$$add)(acc))(1)))(xs);
      }
      var acc = $p1;
      return acc;
    });
...
Prelude.reverse = function($p1){
  return new $(function(){
    ...
    if ($tmp1 instanceof Fay$$Cons) {
      var x = $tmp1.car;
      var xs = $tmp1.cdr;
      return _(_(Prelude["++"])(_(Prelude.reverse)(xs)))(Fay$$list([x]));
    }
    if (_($p1) === null) {
      return null;
    }
...
var FFI = {};
Fay.Yesod = {};
Fay.Yesod._Returns = function Returns(){
};
Fay.Yesod._Returns.prototype.instance = "Returns";
Fay.Yesod.Returns = new $(function(){
  return new Fay.Yesod._Returns();
});
Fay.Yesod.call = function($p1){
  return function($p2){
    return new $(function(){
      var g = $p2;
      var f = $p1;
      return _(_(Fay.Yesod.ajaxCommand)(_(f)(Fay.Yesod.Returns)))(g);
    });
  };
};
Fay.Yesod.callWithErrorHandling = function($p1){
  return function($p2){
    return function($p3){
      return new $(function(){
        var h = $p3;
        var g = $p2;
        var f = $p1;
        return _(_(_(Fay.Yesod.ajaxCommandWithErrorHandling)(_(f)(Fay.Yesod.Returns)))(g))(h);
      });
    };
  };
};
Fay.Yesod.ajaxCommand = function($p1){
  return function($p2){
    return new $(function(){
...
Fay.Yesod.ajaxCommandWithErrorHandling = function($p1){
  return function($p2){
    return function($p3){
      return new $(function(){
...
Fay$$objConcat(Fay$$fayToJsHash,{"Returns": function(type,argTypes,_obj){
  var obj_ = {"instance": "Returns"};
  return obj_;
}});
Fay$$objConcat(Fay$$jsToFayHash,{"Returns": function(type,argTypes,obj){
  return new Fay.Yesod._Returns();
}});
Data.Nullable = {};
Data.Nullable.fromNullable = function($p1){
  return new $(function(){
    if (_($p1) instanceof Fay.FFI._Nullable) {
      var x = _($p1).slot1;
      return _(Prelude.Just)(x);
    }
    if (_($p1) instanceof Fay.FFI._Null) {
      return Prelude.Nothing;
    }
...
Data.Nullable.toNullable = function($p1){
  return new $(function(){
    if (_($p1) instanceof Prelude._Just) {
      var x = _($p1).slot1;
      return _(Fay.FFI.Nullable)(x);
    }
    if (_($p1) instanceof Prelude._Nothing) {
      return Fay.FFI.Null;
    }
  ...
  return function($p2){
    return new $(function(){
      ...
      return (function(){
        ...
        return _(Data.Nullable.fromNullable)(_(_(extract)(prefix))(text));
      })();
    });
  };
};
...
Fay.Text = {};
Fay.Text.Type = {};
Fay.Text.Type.fromString = new $(function(){
...
var JQuery = {};
JQuery.emptyCallback = new $(function(){
  return _(_(Prelude["$"])(Prelude.$_const))(_(Fay$$$_return)(Fay$$unit));
});
  ...
  return function($p2){
    return function($p3){
      return new $(function(){
        ...
        var succ = $p2;
        var ur = $p1;
        return _(_(Prelude["$"])(JQuery["ajax'"]))((function(){
          var $36$_record_to_update = Object.create(Fay$$_(JQuery.defaultAjaxSettings));
          $36$_record_to_update.success = _(Fay.FFI.Defined)(succ);
          $36$_record_to_update.data$39$ = Fay.FFI.Undefined;
          $36$_record_to_update.error$39$ = _(Fay.FFI.Defined)(err);
          $36$_record_to_update.url = _(Fay.FFI.Defined)(ur);
      ...
      return function($p4){
        return new $(function(){
          ...
          return _(_(Prelude["$"])(JQuery["ajax'"]))((function(){
            var $36$_record_to_update = Object.create(Fay$$_(JQuery.defaultAjaxSettings));
            $36$_record_to_update.success = _(Fay.FFI.Defined)(succ);
            $36$_record_to_update.data$39$ = _(Fay.FFI.Defined)(dat);
            $36$_record_to_update.error$39$ = _(Fay.FFI.Defined)(err);
            $36$_record_to_update.url = _(Fay.FFI.Defined)(ur);
            $36$_record_to_update.type$39$ = _(Fay.FFI.Defined)("POST");
            $36$_record_to_update.processData = _(Fay.FFI.Defined)(false);
            $36$_record_to_update.contentType = _(Fay.FFI.Defined)("text/json");
            $36$_record_to_update.dataType = _(Fay.FFI.Defined)("json");
            return $36$_record_to_update;
          })());
        });
      };
        ...
        return function($p5){
          return new $(function(){
            ...
            return _(_(Prelude["$"])(JQuery["ajax'"]))((function(){
              var $36$_record_to_update = Object.create(Fay$$_(JQuery.defaultAjaxSettings));
              $36$_record_to_update.success = _(Fay.FFI.Defined)(succ);
              $36$_record_to_update.data$39$ = _(_(Prelude["$"])(Fay.FFI.Defined))(_(_(JQuery.makeRqObj)(rqparam))(dat));
              $36$_record_to_update.error$39$ = _(Fay.FFI.Defined)(err);
              $36$_record_to_update.url = _(Fay.FFI.Defined)(ur);
              $36$_record_to_update.type$39$ = _(Fay.FFI.Defined)("POST");
              $36$_record_to_update.processData = _(Fay.FFI.Defined)(false);
...
JQuery.contentType = function(x){
  return new $(function(){
    return _(x).contentType;
  });
};
JQuery.crossDomain = function(x){
  return new $(function(){
    return _(x).crossDomain;
  });
};
JQuery["data'"] = function(x){
  return new $(function(){
    return _(x).data$39$;
  });
};
...
JQuery.defaultAjaxSettings = new $(function(){
...
JQuery["ajax'"] = function($p1){
  return new $(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"], (function (o) {  delete o['instance'];  for (var p in o) {  if (/\$39\$/.test(p)) {  o[p.replace(/\$39\$/g, '')] = o[p];  delete o[p];  }  }  o['data'] = JSON.stringify(o['data']);  return jQuery.ajax(o);  })(Fay$$fayToJs(["user","AjaxSettings",[["automatic"],["automatic"]]],$p1))));
  });
};
...
JQuery.selectEmpty = new $(function(){
...
JQuery.noConflict = new $(function(){
...
JQuery.anim = function($p1){
  return function($p2){
    return new $(function(){
      var el = $p2;
      var ty = $p1;
      return _(_(_(_(JQuery.Animation)(ty))(JQuery.Fast))(Prelude.Nothing))(el);
    });
  };
};
  ...
  return function($p2){
    return new $(function(){
      ...
      return (function(){
        ...
        $36$_record_to_update._nextAnimation = _(Prelude.Just)(a2);
        return $36$_record_to_update;
      })();
    });
  };
...
JQuery.chainAnims = function($p1){
  return new $(function(){
    ...
    if ($tmp1 instanceof Fay$$Cons) {
      var a = $tmp1.car;
      var as = $tmp1.cdr;
      return _(_(JQuery.chainAnim)(a))(_(JQuery.chainAnims)(as));
    }
    if (_($p1) === null) {
      return _(Prelude.error)(_(Data.Text.unpack)("chainAnims: empty list"));
    }
...
JQuery.runAnimation = function($p1){
  return new $(function(){
    ...
    return (function(){
      var cb = new $(function(){
        return (function($tmp1){
          if (_($tmp1) instanceof Prelude._Just) {
            var a2 = _($tmp1).slot1;
            return _(Prelude.$_const)(_(JQuery.runAnimation)(a2));
          }
          if (_($tmp1) instanceof Prelude._Nothing) {
            return _(Prelude.$_const)(_(Fay$$$_return)(Fay$$unit));
          }
          return (function(){ throw (["unhandled case",$tmp1]); })();
        })(_(JQuery._nextAnimation)(a));
      });
      return _(_(Fay$$then)(_(_(_(_(JQuery.animate)(_(JQuery._type)(a)))(_(JQuery._speed)(a)))(cb))(_(JQuery._element)(a))))(_(Fay$$$_return)(Fay$$unit));
    })();
  });
};
...
JQuery.hide = function($p1){
  return new $(function(){
    var spd = $p1;
    return _(_(_(JQuery.animate)(JQuery.Hide))(spd))(JQuery.emptyCallback);
  });
};
...
JQuery.jshow = function($p1){
  return new $(function(){
    var spd = $p1;
    return _(_(_(JQuery.animate)(JQuery.Show))(spd))(JQuery.emptyCallback);
  });
};
JQuery.toggle = function($p1){
  return new $(function(){
    var spd = $p1;
    return _(_(_(JQuery.animate)(JQuery.Toggle))(spd))(JQuery.emptyCallback);
  });
};
JQuery.fadeIn = function($p1){
  return new $(function(){
    var spd = $p1;
    return _(_(_(JQuery.animate)(JQuery.FadeIn))(spd))(JQuery.emptyCallback);
  });
};
JQuery.fadeOut = function($p1){
  return new $(function(){
    var spd = $p1;
    return _(_(_(JQuery.animate)(JQuery.FadeOut))(spd))(JQuery.emptyCallback);
  });
};
JQuery.fadeToggle = function($p1){
  return new $(function(){
    var spd = $p1;
    return _(_(_(JQuery.animate)(JQuery.FadeToggle))(spd))(JQuery.emptyCallback);
  });
};
...
JQuery.currentTarget = function($p1){
  return new $(function(){
    return new Fay$$Monad(Fay$$jsToFay(["user","Element",[]],Fay$$fayToJs(["user","Event",[]],$p1)['currentTarget']));
  });
};
...
JQuery.WithoutDataAndEvents = new $(function(){
...
JQuery.WithDataAndEvents = new $(function(){
...
JQuery.DeepWithDataAndEvents = new $(function(){
  return new JQuery._DeepWithDataAndEvents();
});
JQuery.clone = function($p1){
  return new $(function(){
    if (_($p1) instanceof JQuery._WithoutDataAndEvents) {
      return function($p1){
        return new $(function(){
    ...
    if (_($p1) instanceof JQuery._WithDataAndEvents) {
      return function($p1){
        return new $(function(){
    ...
    if (_($p1) instanceof JQuery._DeepWithDataAndEvents) {
      return function($p1){
        return new $(function(){
...
JQuery.onKeycode = function($p1){
  return function($p2){
    return new $(function(){
      var el = $p2;
      var callback = $p1;
      return _(_(JQuery._onKeycode)(function($p1){
        var code = $p1;
        return _(callback)((function($tmp1){
          if (_($tmp1) === 38) {
            return JQuery.KeyUp;
          }
          if (_($tmp1) === 40) {
...
var SharedTypes = {};
SharedTypes._LookupRef = function LookupRef(slot1,slot2){
  this.slot1 = slot1;
  this.slot2 = slot2;
};
SharedTypes._LookupRef.prototype.instance = "LookupRef";
SharedTypes.LookupRef = function(slot1){
  return function(slot2){
    return new $(function(){
      return new SharedTypes._LookupRef(slot1,slot2);
    });
  };
};
SharedTypes._Head = function Head(slot1){
  this.slot1 = slot1;
};
SharedTypes._Head.prototype.instance = "Head";
SharedTypes.Head = function(slot1){
  return new $(function(){
    return new SharedTypes._Head(slot1);
  });
};
Fay$$objConcat(Fay$$fayToJsHash,{"LookupRef": function(type,argTypes,_obj){
  var obj_ = {"instance": "LookupRef"};
  var obj_slot1 = Fay$$fayToJs(["user","Text",[]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  var obj_slot2 = Fay$$fayToJs(["user","Returns",[["user","Text",[]]]],_obj.slot2);
  ...
  var obj_slot1 = Fay$$fayToJs(["user","Returns",[["user","Text",[]]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
}});
Fay$$objConcat(Fay$$jsToFayHash,{"LookupRef": function(type,argTypes,obj){
  return new SharedTypes._LookupRef(Fay$$jsToFay(["user","Text",[]],obj["slot1"]),Fay$$jsToFay(["user","Returns",[["user","Text",[]]]],obj["slot2"]));
},"Head": function(type,argTypes,obj){
  return new SharedTypes._Head(Fay$$jsToFay(["user","Returns",[["user","Text",[]]]],obj["slot1"]));
}});
var Home = {};
var Strict = {};
Strict.Home = {};
Home.alert = function($p1){
  return new $(function(){
    return new Fay$$Monad(Fay$$jsToFay(["unknown"],alert(typeof(Fay$$fayToJs(["user","Text",[]],$p1)) + ': ' + JSON.stringify(Fay$$fayToJs(["user","Text",[]],$p1)))));
  });
};
Home.getHead = new $(function(){
  return _(_(Fay.Yesod.call)(SharedTypes.Head))(Home.alert);
});
Home.evtHandler = function($p1){
  return new $(function(){
    var h = $p1;
    return _(_(Fay$$then)(_(Home.alert)("event handler running.")))(_(Fay$$$_return)(false));
  });
};
Home.main = new $(function(){
  return _(_(Fay$$then)(_(Prelude.putStrLn)(_(Data.Text.unpack)("Got selection "))))(_(_(Fay$$bind)(_(JQuery.select)("#btnPrimary")))(function($p1){
    var button = $p1;
    return _(_(Fay$$then)(_(Prelude.putStrLn)(_(Prelude.show)(button))))(_(_(Fay$$then)(_(_(JQuery.onClick)(Home.evtHandler))(button)))(_(Prelude.putStrLn)(_(Data.Text.unpack)("Set button handler "))));
  }));
});
Strict.Home.alert = Fay$$fayToJs(['automatic'],Home.alert);
Strict.Home.evtHandler = Fay$$fayToJs(['automatic'],Home.evtHandler);
Strict.Home.getHead = Fay$$fayToJs(['automatic'],Home.getHead);
Strict.Home.main = Fay$$fayToJs(['automatic'],Home.main);
Fay$$_(Home.main, true);
