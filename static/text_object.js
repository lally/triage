...
function text_object(text_rep){
	...
	this.check_text_dimensions = function(){
		text_width = this.text_object.node().getBBox().width;	//this.text_object.node().offsetWidth;
		text_height = this.text_object.node().getBBox().height;	//this.text_object.node().offsetHeight;
	}	
